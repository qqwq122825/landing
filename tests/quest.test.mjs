...
test('Quest isolated HTTP integration: registration, grants, preview, branding, download and Pixel',async t=>{
 ...
 const b=await request('/api/projects',master,{name:'Legacy grant account'});assert.deepEqual(b.json.project.allowedTemplates,['feiyue','dptv']);const before=b.json.project;
