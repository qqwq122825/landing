...
const HUB_TEMPLATE_NAMES=['feiyue'=>'ReelShort','dptv'=>'DPTV','quest'=>'Pasion TV','aivideo'=>'AI Video','ggtv'=>'GGTV','appstore'=>'Cast','ultraplay'=>'Ultra Play','yacinetv'=>'Yacine TV','dptvplus'=>'DPTV','fizzio'=>'Fizzio','kyss'=>'KYSS','sparkle'=>'Sparkle','newf'=>'NEW-F','soccerqueens'=>'Soccer Queens','cinema'=>'Netflix Gratis','noxxtv'=>'NOXX','smarttrade'=>'SmartTrade','stockvault'=>'StockVault','loveapp'=>'LoveApp','qiyou'=>'qiyou','stripchat'=>'STRIPCHAT','pornparadise'=>'Porm Paradise','pornhub'=>'Pornhub','chatee'=>'Chatee','cosplay'=>'Cosplay','lustylive'=>'Lusty Live','nightplay'=>'NightPlay','bokep'=>'Website Bokep','xhamster'=>'XHAMSTER','mylive'=>'MyLive','kuaibo'=>'KuaiBo','tikapk'=>'Tik APK','jiaoyou'=>'交友','cyberheart'=>'Cyber Heart Show','promotions'=>'VELOCITY GAMING','india'=>'印度','apuestamx'=>'ApuestaMX'];
