...
const HUB_TEMPLATES=['feiyue','dptv','quest','aivideo','ggtv','appstore','ultraplay','yacinetv','dptvplus','fizzio','kyss','sparkle','newf','soccerqueens','cinema','noxxtv','smarttrade','stockvault'];
